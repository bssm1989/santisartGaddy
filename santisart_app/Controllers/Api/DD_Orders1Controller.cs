    ...
    */
    public class DD_Orders1Controller : ODataController
    {
        ...
        public IQueryable<OrdersDto> GetDD_Orders1()
        {
            ...
            //return db.DD_Orders.ProjectTo<OrdersDto>(config).Include(x=>x.OrderDetailDto).ProjectTo<OrderDetailDto>(config).AsQueryable();
            return db.DD_Orders.Select(mapper.Map<DD_Orders,OrdersDto>).AsQueryable();
        }

        // GET: odata/DD_Orders1(5)
        [EnableQuery]
        ...
        // GET: odata/DD_Orders1(5)/DD_customer
        [EnableQuery]
        ...
        // GET: odata/DD_Orders1(5)/DD_Order_detail
        [EnableQuery]

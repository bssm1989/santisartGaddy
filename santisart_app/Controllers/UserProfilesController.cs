...
namespace santisart_app.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public ActionResult Login(UserProfile objUser)
        {
            ...
            {
                using (santisartEntities3 db2 = new santisartEntities3())
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "UserId,UserName,Password,IsActive")] UserProfile UserProfiles)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,UserName,Password,IsActive")] UserProfile UserProfiles)
        {
            if (ModelState.IsValid)
            {
